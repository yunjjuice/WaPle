...
@font-face { font-family: 'LotteMartHappy'; src: url('https://cdn.jsdelivr.net/korean-webfonts/1/corps/lottemart/LotteMartHappy/LotteMartHappyMedium.woff2') format('woff2'); font-style: normal; font-weight: 400; }
